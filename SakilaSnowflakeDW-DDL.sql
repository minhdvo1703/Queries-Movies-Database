...
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
-- 0 row(s) affected, 10 warning(s): 1681 Integer display width is deprecated and will be removed in a future release. 1681 Integer display width is deprecated and will be removed in a future release. 1681 Integer display width is deprecated and will be removed in a future release. 1681 Integer display width is deprecated and will be removed in a future release. 1681 Integer display width is deprecated and will be removed in a future release. 1681 Integer display width is deprecated and will be removed in a future release. 1681 Integer display width is deprecated and will be removed in a future release. 1681 Integer display width is deprecated and will be removed in a future release. 1681 Integer display width is deprecated and will be removed in a future release. 1681 Integer display width is deprecated and will be removed in a future release.
...
SET UNIQUE_CHECKS=@OLD_UNIQUE_CHECKS;CREATE TABLE IF NOT EXISTS `sakila_snowflake`.`dim_actor` (   `actor_key` INT(10) NOT NULL AUTO_INCREMENT,   `actor_last_update` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,   `actor_id` INT(10) NOT NULL,   `actor_last_name` VARCHAR(45) NOT NULL,   `actor_first_name` VARCHAR(45) NOT NULL,   PRIMARY KEY (`actor_key`)) ENGINE = InnoDB DEFAULT CHARACTER SET = latin1;
CREATE TABLE IF NOT EXISTS `sakila_snowflake`.`dim_actor` (   `actor_key` INT(10) NOT NULL AUTO_INCREMENT,   `actor_last_update` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,   `actor_id` INT(10) NOT NULL,   `actor_last_name` VARCHAR(45) NOT NULL,   `actor_first_name` VARCHAR(45) NOT NULL,   PRIMARY KEY (`actor_key`)) ENGINE = InnoDB DEFAULT CHARACTER SET = latin1
